...
const renderRow = (item: SubjectList) => (
  ...
  >
    ...
    <td className="hidden md:table-cell">{item.teachers.map((teacher) => `${teacher.surname} ${teacher.name[0]}. ${teacher.patronymic?.[0] ?? ""}.`).join(", ")}</td>
    <td>
  ...
  return (
    <div className="bg-white p-4 rounded-md flex-1 m-4 mt-0">
      ...
      <div className="flex items-center justify-between">
        <h1 className="hidden md:block text-lg font-semibold">Предметы</h1>
